...
let imagLogoUcc = document.createElement('img');
let naveg = document.createElement('nav');
let listaMenu = document.createElement('ul');
let subListaMenu = document.createElement('ul');
...
/*****************************************************Listas Desordenadas**********************************************************/
let menuItems = ["/App_Ucc_Interfaces/Vistas/Resources/homemenu.png", "¿Quiénes Somos?", "Nuestra Historia", "/App_Ucc_Interfaces/Vistas/Resources/masopcionesmenu.png"];
let rutasEnlaces = ["/App_Ucc_Interfaces/Vistas/VistasApp/home.jsp", "/App_Ucc_Interfaces/Vistas/VistasApp/quienesSomos.jsp", "#"];

let subMenuItems = ["Perfil", "Ajustes Cuenta", "Cerrar Sesión"];
let rutasEnlaces2 = ["", "", "/App_Ucc_Interfaces/ControlIngreso?accion=salir"];
